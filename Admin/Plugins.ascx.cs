...
namespace Nevoweb.DNN.NBrightBuy.Admin
{
    ...
    public partial class Plugins : NBrightBuyAdminBase
    {
        ...
        override protected void OnInit(EventArgs e)
        {
            ...
            var pageheaderTempl = NBrightBuyUtils.RazorTemplRender("Admin_Plugins_head.cshtml", 0, "", nbi, "/DesktopModules/NBright/NBrightBuy", "config", Utils.GetCurrentCulture(), StoreSettings.Current.Settings());
