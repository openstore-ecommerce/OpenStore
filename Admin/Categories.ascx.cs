...
namespace Nevoweb.DNN.NBrightBuy.Admin
{
    ...
    public partial class Categories : NBrightBuyAdminBase
    {
        ...
        override protected void OnInit(EventArgs e)
        {
            ...
            var pageheaderTempl = NBrightBuyUtils.RazorTemplRender("Admin_Category_head.cshtml", 0, "", nbi, "/DesktopModules/NBright/NBrightBuy", "config", Utils.GetCurrentCulture(), StoreSettings.Current.Settings());
        ...
        private void PageLoad()
        {
            ...
            {
                RazorTemplate = "Admin_Category.cshtml";
